        ...
        <div class="card-body">
          <form action="data_user_action.php?act=simpan" method="post" id="form-tambah">
            <div class="form-group">
              <label for="user_id">Jawaban Mahasiswa ID</label>
              <input type="text" name="jawaban_mahasiswa_id" id="jawaban_mahasiswa_id" class="form-control">
            </div>
            <div class="form-group">
              <label for="username">Responden Mahasiswa ID</label>
              <input required type="text" name="responden_mahasiswa_id" id="responden_mahasiswa_id" class="form-control">
            </div>
            <div class="form-group">
              <label for="nama">Soal ID</label>
              <input required type="text" name="soal_id" id="soal_id" class="form-control">
            </div>
            <div class="form-group">
              <label for="password">Jawaban</label>
              <input required type="text" name="jawaban" id="jawaban" class="form-control">
            </div>
            <div class="form-group">
              <button type="submit" name="simpan" class="btn btn-primary" value="simpan">Simpan</button>
              <a href="jawaban_mahasiswa.php" class="btn btn-warning">Kembali</a>
            </div>
          </form>
        </div>
      </div>
