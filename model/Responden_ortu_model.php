...
class DataRespondenOrtu {
    ...
    public function insertData($data){
        ...
        $query = $this->db->prepare("insert into {$this->table} 
            (survey_id, responden_tanggal, responden_nama, responden_jk, responden_umur, responden_hp, responden_pendidikan, responden_pekerjaan, responden_penghasilan, mahasiswa_nim, mahasiswa_nama, mahasiswa_prodi) 
            values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

        // binding parameter ke query
        $query->bind_param('isssisssssss', 
            $data['survey_id'], 
    ...
    public function getData(){
        // query untuk mengambil data dari tabel t_responden_ortu
    ...
    public function updateData($id, $data){
        ...
        // binding parameter ke query
        $query->bind_param('isssisssssssi', 
            $data['survey_id'], 
            $data['responden_tanggal'], 
            $data['responden_nama'], 
            $data['responden_jk'], 
