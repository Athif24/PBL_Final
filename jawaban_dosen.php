                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        while ($row = $list->fetch_assoc()) {
                            echo '<tr>
                                ...
                                <td>' . $row['jawaban'] . '</td>
                                <td>
                                    <a title="View Data" href="jawaban_dosen_form.php?act=view&id=' . $row['jawaban_dosen_id'] . '" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
