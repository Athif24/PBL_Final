  ...
  <section class="content centered-form">
    ...
    <div class="card form-container">
      <div class="card-header">
        <h3 class="card-title">Survey Tenaga Pendidik</h3>
      ...
      <div class="card-body">
        <form action="responden_tendik_action.php?act=simpan" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="responden_nopeg" name="responden_nopeg" required>
          </div>
          ...
          <div class="form-group">
            <label for="responden_unit">Jurusan</label>
            <input type="text" class="form-control" id="responden_unit" name="responden_unit" required>
          </div>

          <button type="submit" href="responden_tendik_form.php" name="simpan" class="btn btn-primary">Submit</button>
        </form>
      </div>
      <!-- /.card-body -->
      <!-- /.card-footer-->
